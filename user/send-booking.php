...
function sendBookingDetails($id){
    $hname = 'localhost';
$uname = 'root';
$pass = '';
$db = 'hms';
...
if ($conn->connect_error) {
    ...
    $sql = "SELECT bookingid, roomname, email, name, phone, checkin, checkout FROM bookedrooms where bookingid = '$id'";
...
<div class="container">
    ...
    <p>Thank you for choosing our hotel. We are delighted to confirm your appointment and look forward to providing you with an exceptional experience.</p>
    ...
    <div class="call-to-action">
        <p>📞 Call us at <b>+91 987xxxx475</b> within 2 days to confirm your booking and complete the payment.</p>
    </div>
    ...
    <div class="footer">
        ...
        echo "<script>alert('Booking ID not found!'); window.location.href = '../index.php';</script>";
    }
$conn->close();
